                    ...
                    <!-- <div class="col-12 col-md-4 mb-3"> -->
                        ...
                        <?php endif;?>
                            <div class="card-body">
                                ...
                                <?php endif;?>
                                <?php if($mufrodat[$i]['mufrodat'] == 100) :?>
                                    <a href="<?= base_url()?>ft_2/mufrodat?id=<?= MD5($mufrodat[$i]['latihan'])?>" class="btn btn-block btn-sm btn-primary d-flex justify-content-between"><span><i class="fa fa-book mr-1"></i> Belajar </span><span><?= date("H:i d-m-y", strtotime($mufrodat[$i]['tgl']))?></span></a>
                                <?php else :?>
                                    <a href="<?= base_url()?>ft_2/mufrodat?id=<?= MD5($mufrodat[$i]['latihan'])?>" class="btn btn-block btn-sm btn-danger"><i class="fa fa-book mr-1"></i>Belajar</a>
                                <?php endif;?>
                            </div>
                        </div>
                    </div>
