  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="daftarIsiTitle">Materi Full Time 2</h5>
                    ...
                    foreach ($tema as $tema) :?>
                        <div class="col-12 col-md-4 mb-3">
                            <div class="card rounded-lg border-primary>">
                                ...
                                <div class="card-body">
                                    <a href="#daftarIsi" data-id="<?= $tema['bab']?>" data-toggle="modal" class="d-flex justify-content-center btn btn-block btn-sm btn-primary btnDaftarIsi"><span><?= $tema['bab'] . ". " . $tema['title_arti']?></span></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach;?>
...
<script>
    $(".btnMulai").click(function(){
        $("#daftarIsiTitle").html("Materi Full Time 2")
        ...
        $.ajax({ 
            ...
            success: function (data) {
                ...
                html = `<li class="list-group-item d-flex justify-content-between">
                    ...
                    <span><a href="<?= base_url()?>ft_2/mufrodat?tema=`+data.link+`" class="btn btn-sm btn-info"><i class="fa fa-book text-light mr-1"></i> Mulai!</a></span>
                    </li>`;
                ...
                data.forEach(function (data) {
                    html += `<li class="list-group-item d-flex justify-content-between" style="font-size: 20px">
                        ...
                        <span><a href="<?= base_url()?>ft_2/mufrodat?id=`+data.tema+`" class="btn btn-sm btn-info"><i class="fa fa-book text-light mr-1"></i> Mulai!</a></span>
                    </li>`
                }); 
