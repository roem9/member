        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    <img src="<?= base_url()?>assets/img/qowaid_ft1/7.1.jpg" class="img-rounded img-fluid" alt="Cinque Terre">
                </div>
                <div class="col-12 mb-3">
                ...
                <div class="col-12">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><a href="#daftarIsi" data-toggle="modal" data-id="<?= base_url()?>ft_1/qowaid?ln=<?= Md5('Fiil Madhi')?>&i=1" class="btn btn-sm btn-block btn-success btnMulai">Latihan 1</a></li>
