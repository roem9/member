        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    <img src="<?= base_url()?>assets/img/qowaid_ft1/14.1.jpg" class="img-rounded img-fluid" alt="Cinque Terre">
                </div>
                <div class="col-12 mb-3">
                    <div class="d-flex justify-content-between">
                        <a href="<?= base_url()?>ft_1/qowaid?id=<?= MD5('Isyarah Musyar Ilaih')?>" class="btn btn-sm list-group-item-warning"><i class="fa fa-arrow-left "></i></a>
                        <a href="<?= base_url()?>ft_1/qowaid?id=<?= MD5('Mausul')?>" class="btn btn-sm list-group-item-warning"><i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-12">
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-warning">Latihan</li>
                        <li class="list-group-item"><a href="<?= base_url()?>ft_1/qowaid?ln=<?= Md5('Idhafah')?>&i=1" class="btn btn-sm btn-block btn-success btnMulai">Latihan 1</a></li>
